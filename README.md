...
Progression layers:
1. **Chips** — spend on table upgrades (Auto Dealer, Multi Deal, Big Blind, Pin Tip, …). Auto Dealer is cheap through Lv 6 then pricier; **Multi Deal** adds a chance for extra cards per auto tick (caps at 150%; above 100% can deal multiple). Hot Streak caps at Lv 10. **Short Fuse** speeds hand clears but is toggleable when you want more time to stack combos or Card Counting pairs. **Suit Purge** pays per card; the shop toggle or bar tap can hide the suit picker without stopping purges. The HUD shows your balance and a live chips/s rate. Many upgrades stay hidden until unlocked.
