...
Progression layers:
1. **Chips** — spend on table upgrades (Auto Dealer, Multi Deal, Big Blind, Pin Tip, …). Auto Dealer is cheap through Lv 6 then pricier; **Multi Deal** adds a chance for extra cards per auto tick (above 100% can deal multiple). Hot Streak caps at Lv 10. The HUD shows your balance and a live chips/s rate. Many upgrades stay hidden until unlocked.
