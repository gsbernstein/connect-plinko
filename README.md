...
Full-height layout: the table scales to fit, and the sidebar tabs scroll with the tab bar pinned at the bottom. On narrow screens the table is its own tab. Tabs unlock as you go — Upgrades after your first hand, Quests from run Lv 2, VIP at run Lv 8. Badges show affordable upgrades / ready claims.
